@echo off
REM Diagnostic: V3 nohead systemecho gate with full top-8 rank dump per query.
setlocal
set "ENGINE=%~dp0"
...
set "SP_QKEY_MINT=1"
set "SP_RECALL_L5_DUMPRANK=1"
set "CUBLAS_WORKSPACE_CONFIG=:16:8"
set "SP_DAEMON_LOG=%ENGINE%_v3_serve_dump.log"
echo [V3-dumprank] systemecho + full rank dump
