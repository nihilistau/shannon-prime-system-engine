#ifndef HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_ffn_2stage_halide_h
#define HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_ffn_2stage_halide_h
#include <stdint.h>
...
int sp_ffn_2stage_halide(struct halide_buffer_t *_X_buffer, struct halide_buffer_t *_W1_buffer, struct halide_buffer_t *_W2_buffer, int32_t _b_term, uint8_t _q_bits, struct halide_buffer_t *_Y_buffer);

HALIDE_FUNCTION_ATTRS
int sp_ffn_2stage_halide_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *sp_ffn_2stage_halide_metadata();
