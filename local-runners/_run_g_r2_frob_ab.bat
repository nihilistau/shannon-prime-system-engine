...
set "OUT=%SP_ENGINE%\_g_r2_frobab"
...
echo ===== HIT frob24 a16b8 bit-exact =====
set "SP_REPLAY=%SP_ENGINE%\_c2_ep_wiki_frob24"
"%EXE%" > "%OUT%\ppl_frob16.log" 2>&1
echo FROB16_EXIT=%ERRORLEVEL%

echo ===== HIT frob12 a8b4 =====
set "SP_REPLAY=%SP_ENGINE%\_c2_ep_wiki_frob12"
