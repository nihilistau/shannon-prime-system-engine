...
async fn chat_handler(
    ...
    tokio::spawn(async move {
        ...
        // tx drops here → ReceiverStream ends → SSE connection closes cleanly
    });
...
fn build_console_router() -> Router {
    Router::new()
...
pub async fn start_operator_console() {
    let app = build_console_router();
