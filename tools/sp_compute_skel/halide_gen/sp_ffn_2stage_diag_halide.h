#ifndef HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_ffn_2stage_diag_halide_h
#define HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_ffn_2stage_diag_halide_h
#include <stdint.h>
...
int sp_ffn_2stage_diag_halide(struct halide_buffer_t *_X_buffer, struct halide_buffer_t *_W1_buffer, struct halide_buffer_t *_W2_buffer, int32_t _b_term, uint8_t _q_bits, struct halide_buffer_t *_Y_buffer, struct halide_buffer_t *_hidden_out_buffer);

HALIDE_FUNCTION_ATTRS
int sp_ffn_2stage_diag_halide_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *sp_ffn_2stage_diag_halide_metadata();
...
// @}
typedef enum halide_hexagon_malloc_trace_level_t {
    halide_hexagon_malloc_no_trace = 0,
    halide_hexagon_malloc_min_trace = 1,
    halide_hexagon_malloc_max_trace = 2
} halide_hexagon_malloc_trace_level_t;

 /** Enable the tracing of halide_malloc calls on offloaded pipelines
 * running on Hexagon.
 * You can choose between 3 values for the amount of tracing output
 * produced.
 * halide_hexagon_malloc_no_trace - No tracing output is produced.
 * halide_hexagon_malloc_min_trace - Tracing output is produced when memory is allocated or freed
 * halide_hexagon_malloc_max_trace - All the tracing output that is produced with halide_hexagon_malloc_min_trace
 * and also when halide_malloc is called. Produces a lot of tracing messages.*/
// @{
extern int halide_hexagon_set_malloc_tracing(void *user_context, halide_hexagon_malloc_trace_level_t lev);
extern void halide_hexagon_malloc_tracing_alloc(void *ptr, size_t size);
extern void halide_hexagon_malloc_tracing_failed_alloc(size_t size);
extern void halide_hexagon_malloc_tracing_free(void *ptr);
extern void halide_hexagon_malloc_tracing_log_request(size_t size);
typedef void (*hexagon_malloc_tracing_alloc_t)(void *, size_t);
typedef void (*hexagon_malloc_tracing_failed_alloc_t)(size_t size);
typedef void (*hexagon_malloc_tracing_log_request_t)(size_t size);
typedef void (*hexagon_malloc_tracing_free_t)(void *);
extern hexagon_malloc_tracing_alloc_t halide_set_custom_malloc_tracing_alloc(hexagon_malloc_tracing_alloc_t user_fn);
extern hexagon_malloc_tracing_failed_alloc_t halide_set_custom_malloc_tracing_failed_alloc(hexagon_malloc_tracing_failed_alloc_t user_fn);
extern hexagon_malloc_tracing_log_request_t halide_set_custom_malloc_tracing_log_request(hexagon_malloc_tracing_log_request_t user_fn);
extern hexagon_malloc_tracing_free_t halide_set_custom_malloc_tracing_free(hexagon_malloc_tracing_free_t user_fn);
// @}
