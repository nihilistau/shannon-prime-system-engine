...
set "SP_RECALL_REGISTRY=D:\F\shannon-prime-repos\shannon-prime-system-engine\tests\fixtures\chat_fullstack\reg_needle4.jsonl"
set "SP_B3_DISPOSER=2"
set "SP_B3_SECRET= 400 micro-Hertz"
