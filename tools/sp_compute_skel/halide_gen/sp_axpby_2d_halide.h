#ifndef HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_axpby_2d_halide_h
#define HALIDE__D______F___shannon___prime___repos___shannon___prime___system___engine___tools___sp_halide_gen________sp_compute_skel___halide_gen___sp_axpby_2d_halide_h
#include <stdint.h>
...
int sp_axpby_2d_halide(struct halide_buffer_t *_x_buffer, struct halide_buffer_t *_a_buffer, int32_t _b, uint8_t _q_bits, struct halide_buffer_t *_y_buffer);

HALIDE_FUNCTION_ATTRS
int sp_axpby_2d_halide_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *sp_axpby_2d_halide_metadata();
